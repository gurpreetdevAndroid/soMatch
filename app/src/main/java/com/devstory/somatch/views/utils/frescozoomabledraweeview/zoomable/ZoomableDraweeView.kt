...
open class ZoomableDraweeView : DraweeView<GenericDraweeHierarchy>, ScrollingView {
    ...
    private val mTapListenerWrapper = GestureListenerWrapper(GestureDetector.SimpleOnGestureListener())
    ...
    private fun inflateHierarchy(context: Context, attrs: AttributeSet?) {
